			...
			<form onSubmit={LoginForm.handleSubmit} className="w-7/12 mx-auto">
				<div className="mb-5">
					...
					{LoginForm.touched.email && LoginForm.errors.email ? (
						<p className="text-red-800  dark:text-red-400 ">{LoginForm.errors.email}</p>
					) : (
						""
					)}
				</div>
				<div className="mb-5">
					...
					{LoginForm.touched.password && LoginForm.errors.password ? (
						<p className="text-red-800 dark:text-red-400  ">{LoginForm.errors.password}</p>
					) : (
						""
					)}
				</div>
				...
				<button
					...
					type="submit"
					className="mt-4 text-white bg-active hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-active font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-active dark:hover:bg-active dark:focus:ring-active disabled:bg-active disabled:opacity-50"
				>
					Login
				</button>
			</form>
